...
class UNO3D(nn.Module):
    def __init__(self, in_width, width, out_channel):
        ...
        self.conv0 = OperatorBlock_3D(self.width, 2*self.width, 32, 32, 12, 16, 16, 6, Normalize = True)
        self.conv1 = OperatorBlock_3D(2*self.width, 4*self.width, 16, 16, 6, 8, 8, 3, Normalize = True)
        self.conv2 = OperatorBlock_3D(4*self.width, 8*self.width, 8, 8, 3, 4, 4, 3, Normalize = True)
        self.conv3 = OperatorBlock_3D(8*self.width, 16*self.width, 4, 4, 2, 4, 4, 3, Normalize = True)
        self.conv4 = OperatorBlock_3D(16*self.width, 16*self.width, 4, 4, 2, 4, 4, 3, Normalize = True)
        self.conv5 = OperatorBlock_3D(32*self.width, 8*self.width, 8, 8, 3, 4, 4, 3, Normalize = True)
        self.conv6 = OperatorBlock_3D(16*self.width, 4*self.width, 16, 16, 6, 4, 4, 3, Normalize = True)
        self.conv7 = OperatorBlock_3D(8*self.width, 2*self.width, 32, 32, 12, 4, 4, 3, Normalize = True)
        self.conv8 = OperatorBlock_3D(4*self.width, 2*self.width, 32, 32, 12, 4, 4, 3, Normalize = True)
